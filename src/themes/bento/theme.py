...
from qt_api import QColor, QFont, QFontDatabase, QIcon, QPalette
...
QPushButton#dock-close-button {
    image: url({PATH}themes/bento/images/dock-close.svg);
    padding: 0px;
    padding-top: 2px;
    padding-bottom: 2px;
    margin: 0px;
...
QPushButton#dock-float-button {
    image: url({PATH}themes/bento/images/dock-float.svg);
    padding: 0px;
    padding-top: 2px;
    padding-bottom: 2px;
    margin: 0px;
...
QLabel#dock-title-handle {
    padding-left: 16px;
    qproperty-pixmap: url({PATH}themes/bento/images/dock-move.svg);
}

QDockWidget {
    background-color: #141923;
    titlebar-close-icon: url({PATH}themes/bento/images/dock-close.svg);
    titlebar-normal-icon: url({PATH}themes/bento/images/dock-float.svg);
    color: #91C3FF;
    font-weight: 500;
    padding: 16px;
}
...
QDoubleSpinBox::up-arrow {
    image: url({PATH}themes/bento/images/spin-up-arrow.svg);
    width: 12px;
    height: 12px;
}
...
QDoubleSpinBox::down-arrow {
    image: url({PATH}themes/bento/images/spin-down-arrow.svg);
    width: 12px;
    height: 12px;
}
...
QComboBox::down-arrow {
    image: url({PATH}themes/bento/images/dropdown-arrow.svg);
}
...
QComboBox::indicator::checked {
    image: url({PATH}themes/bento/images/dropdown-tick.svg);
}
...
QMenuBar, QToolBar#toolBar, QToolBar#timelineToolbar {
    background-color: #181818;
    color: #ffffff;
}
QMenuBar::item:selected, QMenu::item:selected,
QToolBar#toolBar QToolButton:hover, QToolBar#timelineToolbar QToolButton:hover {
    background-color: #252525;
    color: #ffffff;
}
QMenu, QTableView, QTreeView, QListView, QComboBox QAbstractItemView {
    background-color: #181818;
    color: #ffffff;
    border-color: #4d4d4d;
}
QHeaderView::section, QToolBox::tab {
    background-color: #181818;
    color: #b3b3b3;
    border-color: #4d4d4d;
}
...
QPushButton#acceptButton:hover, QPushButton#acceptButton:focus {
...
QTabBar::tab:selected {
    color: #ffffff;
    border-bottom: 2px solid #c6c1ae;
}
QDockWidget, QDockWidget QWidget#dockFilesContents,
QDockWidget QWidget#dockTransitionsContents, QDockWidget QWidget#dockEmojisContents,
QDockWidget QWidget#dockEffectsContents, QDockWidget QWidget#dockPropertiesContents {
    background-color: #121212;
    color: #ffffff;
}
...
QWidget#editorPanel, QFrame#editorContextPanel, QWidget#editorBrowserPage,
QWidget#editorElementsBody, QWidget#editorPropertiesBody {
    background-color: #121212;
}
QFrame#editorSectionRail {
    background-color: #181818;
    border-right: 1px solid #252525;
}
QToolButton#editorSectionButton {
    background-color: transparent;
    color: #b3b3b3;
    border: none;
    border-radius: 10px;
...
QToolButton#editorSectionButton:hover {
    background-color: #252525;
    color: #ffffff;
}
QToolButton#editorSectionButton:checked {
    background-color: #c6c1ae;
    color: #121212;
}
QLabel#editorContextTitle {
    color: #ffffff;
    font-size: 18px;
    font-weight: 700;
}
QToolButton#editorCollapseButton {
    background-color: #1f1f1f;
    color: #b3b3b3;
    border-radius: 12px;
    min-width: 24px;
...
QFrame#editorSearchField {
    background-color: #1f1f1f;
    border: 1px solid #4d4d4d;
    border-radius: 16px;
    min-height: 32px;
}
QFrame#editorSearchField:focus-within {
    border-color: #c6c1ae;
}
QLineEdit#editorBrowserSearch {
    background-color: transparent;
    border: none;
    border-radius: 0;
    color: #ffffff;
...
QToolButton#editorCategoryButton {
    background-color: #1f1f1f;
    color: #b3b3b3;
    border-radius: 14px;
    padding: 6px 10px;
}
QToolButton#editorCategoryButton:checked {
    background-color: #c6c1ae;
    color: #121212;
}
QWidget#editorCardGrid, QScrollArea#editorCardBrowser {
    background-color: transparent;
    border: none;
}
QToolButton#editorContentCard {
    background-color: #181818;
    color: #ffffff;
...
QToolButton#editorContentCard:hover {
    background-color: #252525;
    border-color: #4d4d4d;
}
QToolButton#editorContentCard:checked {
    background-color: #272727;
    border-color: #c6c1ae;
}
QToolButton#editorToolCard {
    background-color: #181818;
    color: #ffffff;
    border: 1px solid #252525;
    border-radius: 10px;
...
QToolButton#editorToolCard:hover {
    background-color: #252525;
    border-color: #4d4d4d;
}
QFrame#editorToolIconBadge {
    background-color: #ffffff;
    border-radius: 10px;
}
QLabel#editorToolIcon {
    background-color: transparent;
}
QLabel#editorToolTitle {
    color: #ffffff;
    font-size: 13px;
    font-weight: 700;
}
QLabel#editorToolDescription {
    color: #a8a8a8;
    font-size: 11px;
    font-weight: 400;
}
QWidget#youtubeEmbedPage {
    background-color: #121212;
}
QFrame#youtubeSearchField {
    background-color: #101014;
    border: 1px solid #4d4d4d;
    border-radius: 10px;
    min-height: 36px;
}
QLineEdit#youtubeSearchInput {
    background-color: transparent;
    border: none;
    color: #ffffff;
    padding: 5px 0;
}
QListWidget#youtubeSuggestions {
    background-color: #1f1f1f;
...
QListWidget#youtubeSuggestions::item {
    padding: 7px 8px;
    border-radius: 5px;
}
QListWidget#youtubeSuggestions::item:hover {
    background-color: #303030;
}
QLabel#youtubeEmptyState {
    color: #d6d2c6;
    font-size: 14px;
    font-weight: 700;
    padding: 28px 12px;
...
QLabel#youtubeResultThumbnail {
    background-color: #252525;
    border-radius: 9px;
    color: #8c8c8c;
    min-height: 118px;
}
QLabel#youtubeResultTitle {
    color: #ffffff;
    font-size: 13px;
    font-weight: 700;
}
QLabel#youtubeResultChannel, QLabel#youtubeResultDuration {
    color: #a8a8a8;
    font-size: 11px;
}
QToolButton#editorToolBackButton {
...
QToolButton#editorToolBackButton:hover {
    background-color: #3a3a3a;
}
        """

    @classmethod
    def _load_inter(cls, log):
        if cls._inter_family:
            return cls._inter_family
        font_path = os.path.join(
            PATH, "themes", "bento", "fonts", "Inter-VariableFont_wght.ttf")
        font_id = QFontDatabase.addApplicationFont(font_path)
        families = QFontDatabase.applicationFontFamilies(font_id) if font_id >= 0 else []
        if not families:
            log.warning("Unable to load Bento font: %s", font_path)
            return None
        cls._inter_font_id = font_id
        cls._inter_family = families[0]
        return cls._inter_family
    ...
    def apply_theme(self):
        ...
        palette.setColor(QPalette.Light, QColor("#4d4d4d"))
        palette.setColor(QPalette.Text, QColor("#ffffff"))
        palette.setColor(QPalette.Button, QColor("#1f1f1f"))
        palette.setColor(QPalette.ButtonText, QColor("#ffffff"))
        palette.setColor(QPalette.Highlight, QColor("#c6c1ae"))
        palette.setColor(QPalette.HighlightedText, QColor("#121212"))
        palette.setColor(QPalette.ToolTipBase, QColor("#1f1f1f"))
        palette.setColor(QPalette.ToolTipText, QColor("#ffffff"))
        palette.setColor(QPalette.Link, QColor("#539df5"))
        palette.setColor(QPalette.LinkVisited, QColor("#b3b3b3"))
        palette.setColor(QPalette.Disabled, QPalette.WindowText, QColor("#7c7c7c"))
        palette.setColor(QPalette.Disabled, QPalette.Text, QColor("#7c7c7c"))
        palette.setColor(QPalette.Disabled, QPalette.ButtonText, QColor("#7c7c7c"))
        self.app.setPalette(palette)

        # Set font for all widgets
        font = QFont(self._load_inter(log) or "Inter")
        ...
        toolbar_buttons = [
            {"action": self.app.window.actionNew, "icon": "themes/bento/images/tool-new-project.svg", "style": Qt.ToolButtonTextBesideIcon},
            {"action": self.app.window.actionOpen, "icon": "themes/bento/images/tool-open-project.svg", "style": Qt.ToolButtonTextBesideIcon},
            {"action": self.app.window.actionImportFiles, "icon": "themes/bento/images/tool-import-files.svg", "style": Qt.ToolButtonTextBesideIcon},
            {"action": self.app.window.actionProfile, "icon": "themes/bento/images/tool-profile.svg", "style": Qt.ToolButtonTextBesideIcon},
            {"expand": True},
            {"action": self.app.window.actionSave, "icon": "themes/bento/images/tool-save-project.svg", "style": Qt.ToolButtonTextBesideIcon},
            {"action": self.app.window.actionExportVideo, "icon": "themes/bento/images/tool-export.svg",
        ...
        self.app.window.actionColor_Grade_View.setIcon(
            QIcon(os.path.join(PATH, "themes/bento/images/view-color.svg"))
        )

        # Timeline toolbar buttons
        timeline_buttons = [
            {"action": self.app.window.actionAddTrack, "icon": "themes/bento/images/tool-add-track.svg", "style": Qt.ToolButtonTextBesideIcon, "stylesheet": "QToolButton { margin-left: 15px; }"},
            {"action": self.app.window.actionUndo, "icon": "themes/bento/images/tool-undo.svg", "style": Qt.ToolButtonIconOnly, "stylesheet": "QToolButton { margin-right: 0px; border-bottom-right-radius: 0px; border-top-right-radius: 0px; }"},
            {"action": self.app.window.actionRedo, "icon": "themes/bento/images/tool-redo.svg", "style": Qt.ToolButtonIconOnly, "stylesheet": "QToolButton { margin-left: 0px; border-bottom-left-radius: 0px; border-top-left-radius: 0px; }"},
            {"action": self.app.window.actionSnappingTool, "icon": "themes/bento/images/tool-snapping.svg", "style": Qt.ToolButtonIconOnly, "stylesheet": "QToolButton { margin-right: 0px; border-bottom-right-radius: 0px; border-top-right-radius: 0px; } QToolButton:focus { border: 1px solid #5aa2e6; background-color: #141923; } QToolButton:checked:focus { border: 1px solid #5aa2e6; background-color: #283241; }"},
            {"action": self.app.window.actionTimingTool, "icon": "themes/bento/images/tool-timing.svg", "style": Qt.ToolButtonIconOnly, "stylesheet": "QToolButton { margin-left: 0px; margin-right: 0px; border-bottom-left-radius: 0px; border-top-left-radius: 0px; border-bottom-right-radius: 0px; border-top-right-radius: 0px; } QToolButton:focus { border: 1px solid #5aa2e6; background-color: #141923; } QToolButton:checked:focus { border: 1px solid #5aa2e6; background-color: #283241; }"},
            {"action": self.app.window.actionRazorTool, "icon": "themes/bento/images/tool-razor.svg", "style": Qt.ToolButtonIconOnly, "stylesheet": "QToolButton { margin-left: 0px; border-bottom-left-radius: 0px; border-top-left-radius: 0px; } QToolButton:focus { border: 1px solid #5aa2e6; background-color: #141923; } QToolButton:checked:focus { border: 1px solid #5aa2e6; background-color: #283241; }"},
            {"action": self.app.window.actionAddMarker, "icon": "themes/bento/images/tool-add-marker.svg", "style": Qt.ToolButtonTextBesideIcon, "stylesheet": "QToolButton { margin-right: 0px; border-bottom-right-radius: 0px; border-top-right-radius: 0px; }"},
            {"action": self.app.window.actionPreviousMarker, "icon": "themes/bento/images/tool-prev-marker.svg", "style": Qt.ToolButtonIconOnly, "stylesheet": "QToolButton { margin-left: 0px; border-bottom-left-radius: 0px; border-top-left-radius: 0px; margin-right: 0px; border-bottom-right-radius: 0px; border-top-right-radius: 0px; }"},
            {"action": self.app.window.actionNextMarker, "icon": "themes/bento/images/tool-next-marker.svg", "style": Qt.ToolButtonIconOnly, "stylesheet": "QToolButton { margin-left: 0px; border-bottom-left-radius: 0px; border-top-left-radius: 0px; }"},
            {"action": self.app.window.actionCenterOnPlayhead, "icon": "themes/bento/images/tool-center-playhead.svg", "style": Qt.ToolButtonIconOnly, "stylesheet": "QWidget { margin-right: 10px; }"},
        ...
        toolbar_buttons = [
            {"expand": True},
            {"action": self.app.window.actionJumpStart, "icon": "themes/bento/images/tool-media-skip-back.svg", "style": Qt.ToolButtonIconOnly},
            {"action": self.app.window.actionRewind, "icon": "themes/bento/images/tool-media-rewind.svg", "style": Qt.ToolButtonIconOnly},
            {"action": self.app.window.actionPlay, "icon": "themes/bento/images/tool-media-play.svg", "style": Qt.ToolButtonIconOnly},
            {"action": self.app.window.actionFastForward, "icon": "themes/bento/images/tool-media-forward.svg", "style": Qt.ToolButtonIconOnly},
            {"action": self.app.window.actionJumpEnd, "icon": "themes/bento/images/tool-media-skip-forward.svg", "style": Qt.ToolButtonIconOnly},
            {"expand": True}
        ]
        self.set_toolbar_buttons(self.app.window.videoToolbar, icon_size=32, settings=toolbar_buttons)

        from .styles import BentoTimelineTheme
        self.app.window.timeline.apply_theme(BentoTimelineTheme())
    ...
    def togglePlayIcon(self, isPlay):
        ...
        if button:
            ...
            icon_path = os.path.join(PATH, "themes/bento/images", icon_name)

...
_libopenshot_root = os.path.join(_root, "libopenshot")
_libopenshot_python = os.path.join(_libopenshot_root, "python")
_libopenshot_bin = os.path.join(_libopenshot_root, "bin")

if os.path.isdir(_libopenshot_python):
    sys.path.insert(0, _libopenshot_python)

_libopenshot_dll_handle = None

if os.name == "nt" and os.path.isdir(_libopenshot_bin):
    _libopenshot_dll_handle = os.add_dll_directory(_libopenshot_bin)

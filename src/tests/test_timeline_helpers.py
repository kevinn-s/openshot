...
class TimelineHelperTests(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.bento_theme_module = importlib.import_module("themes.bento.styles")
    ...
    def test_transition_themes_use_two_pixel_border_width(self):
        bento = self.bento_theme_module.BentoTimelineTheme()
        ...
        self.assertEqual(bento.transition.border_width, 2.0)

...
def banner_colors(window, theme=None):
    """Explicit contrast pairs for OpenShot's themes, with a palette fallback."""
    ...
    if name == "Bento":
        return dict(backdrop="#121212", surface="#181818", border="#4d4d4d", text="#fdfdfd",
                    action="#c6c1ae", close="#b3b3b3", hover="#252525")
